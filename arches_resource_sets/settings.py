"""
Django settings for arches_resource_sets project.
"""
...
DATATYPE_LOCATIONS.append("arches_resource_sets.datatypes")
FUNCTION_LOCATIONS.append("arches_resource_sets.functions")
ETL_MODULE_LOCATIONS.append("arches_resource_sets.etl_modules")
SEARCH_COMPONENT_LOCATIONS.append("arches_resource_sets.search_components")
...
SECRET_KEY = "rs0_n%ydc(u=ue-aw208=1hw!=$ba(dz@uz7ob_s_hq27*l9=!"
...
ELASTICSEARCH_PREFIX = "arches_resource_sets"

ELASTICSEARCH_CUSTOM_INDEXES = []
# [{
#     'module': 'arches_resource_sets.search_indexes.sample_index.SampleIndex',
...
INSTALLED_APPS = (
    ...
    "pgtrigger",
    # "silk",
    "arches_resource_sets",  # Ensure the project is listed before any other arches applications
)
...
WSGI_APPLICATION = "arches_resource_sets.wsgi.application"
...
SESSION_COOKIE_NAME = "arches_resource_sets"
...
# ES_MAPPING_MODIFIER_CLASSES = ["arches_resource_sets.search.es_mapping_modifier.EsMappingModifier"]
