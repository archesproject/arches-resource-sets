...
module.exports = {
  input: {
    path: "./arches_resource_sets/src", // only files in this directory are considered for extraction
  ...
  output: {
    path: "./arches_resource_sets/locale", // output path of all created files
